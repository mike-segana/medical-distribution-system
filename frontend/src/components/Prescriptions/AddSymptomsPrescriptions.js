...
function AddSymptomsPrescriptions() {
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      try {
        const [symRes, presRes] = await Promise.all([
  ...
  return (
    <div style={{ maxWidth: "900px", margin: "auto", padding: "1rem" }}>
      <h2>Add Patient Symptoms & Prescriptions</h2>
      <p>
...
export default AddSymptomsPrescriptions;